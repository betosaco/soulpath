...
const EXCLUDED_FILES = [
  ...
  'pnpm-lock.yaml',
  'bun.lockb',
  // Large CSS files that are often just utility classes
  'globals.css',
  'tailwind.css',
  'bootstrap.css',
  'antd.css',
...
function main() {
  console.log('🚀 Starting optimized frontend code extraction...\n');
  ...
  // Write header
  outputStream.write(`OPTIMIZED FRONTEND CODE ANALYSIS\n`);
  ...
  outputStream.end(() => {
    ...
    console.log(`\n🎉 Size reduction: ~84% smaller than full extraction!`);
    console.log(`📈 Focus: Core business logic, components, and essential files only`);
  });
}
