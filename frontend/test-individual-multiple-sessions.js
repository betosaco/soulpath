// Test script for individual booking with multiple sessions
const testData = {
  customerInfo: {
...
async function testIndividualMultipleSessions() {
  try {
    console.log('🧪 Testing individual booking with multiple sessions...');
    ...
    if (response.ok) {
      ...
      console.log('📬 Check your email inbox for the individual booking with multiple sessions');
...
testIndividualMultipleSessions();
