...
async function main() {
  ...
  const orders = await Promise.all([
    prisma.order.upsert({
      ...
      create: {
        ...
        customerName: clients[0].fullName || 'John Doe',
    ...
    prisma.order.upsert({
      ...
      create: {
        ...
        customerName: clients[1].fullName || 'Maria Garcia',
  ...
  const teacherSchedules = await Promise.all([
    ...
    prisma.teacherSchedule.upsert({
      ...
      create: {
        ...
        serviceTypeId: 1, // Hatha Yoga
        dayOfWeek: 'Monday',
        startTime: new Date('1970-01-01T03:15:00Z'), // 08:15 EST - 15 hours = 03:15 UTC (previous day)
        endTime: new Date('1970-01-01T04:15:00Z'), // 09:15 EST - 15 hours = 04:15 UTC (previous day)
        isAvailable: true,
        maxBookings: 15
      }
    }),
    prisma.teacherSchedule.upsert({
      ...
      create: {
        ...
        serviceTypeId: 2, // Vinyasa Yoga
        dayOfWeek: 'Monday',
        startTime: new Date('1970-01-01T04:30:00Z'), // 09:30 EST - 15 hours = 04:30 UTC (previous day)
        endTime: new Date('1970-01-01T05:30:00Z'), // 10:30 EST - 15 hours = 05:30 UTC (previous day)
        isAvailable: true,
        maxBookings: 15
      }
    }),
    prisma.teacherSchedule.upsert({
      ...
      create: {
        ...
        serviceTypeId: 1, // Hatha Yoga
        dayOfWeek: 'Monday',
        startTime: new Date('1970-01-01T12:30:00Z'), // 17:30 EST - 15 hours = 12:30 UTC
        endTime: new Date('1970-01-01T13:30:00Z'), // 18:30 EST - 15 hours = 13:30 UTC
        isAvailable: true,
        maxBookings: 15
      }
    }),
    ...
    prisma.teacherSchedule.upsert({
      ...
      create: {
        ...
        serviceTypeId: 2, // Vinyasa Yoga
        dayOfWeek: 'Tuesday',
        startTime: new Date('1970-01-01T13:45:00Z'), // 18:45 EST - 15 hours = 13:45 UTC
        endTime: new Date('1970-01-01T14:45:00Z'), // 19:45 EST - 15 hours = 14:45 UTC
        isAvailable: true,
        maxBookings: 15
      }
    }),
    ...
    prisma.teacherSchedule.upsert({
      ...
      create: {
        ...
        serviceTypeId: 1, // Hatha Yoga
        dayOfWeek: 'Saturday',
        startTime: new Date('1970-01-01T03:30:00Z'), // 08:30 EST - 15 hours = 03:30 UTC (previous day)
        endTime: new Date('1970-01-01T04:30:00Z'), // 09:30 EST - 15 hours = 04:30 UTC (previous day)
        isAvailable: true,
        maxBookings: 15
      }
    }),
    prisma.teacherSchedule.upsert({
      ...
      create: {
        ...
        serviceTypeId: 2, // Vinyasa Yoga
        dayOfWeek: 'Saturday',
        startTime: new Date('1970-01-01T04:45:00Z'), // 09:45 EST - 15 hours = 04:45 UTC (previous day)
        endTime: new Date('1970-01-01T05:45:00Z'), // 10:45 EST - 15 hours = 05:45 UTC (previous day)
        isAvailable: true,
        maxBookings: 15
      }
    })
  ...
  const scheduleSlots = await Promise.all([
    ...
    prisma.teacherScheduleSlot.upsert({
      ...
      create: {
        ...
        startTime: new Date('2025-10-06T03:15:00Z'), // 08:15 EST - 15 hours = 03:15 UTC (previous day)
        endTime: new Date('2025-10-06T04:15:00Z'), // 09:15 EST - 15 hours = 04:15 UTC (previous day)
        isAvailable: true,
        bookedCount: 0,
        maxBookings: 15
      }
    ...
    prisma.teacherScheduleSlot.upsert({
      ...
      create: {
        ...
        startTime: new Date('2025-10-06T04:30:00Z'), // 09:30 EST - 15 hours = 04:30 UTC (previous day)
        endTime: new Date('2025-10-06T05:30:00Z'), // 10:30 EST - 15 hours = 05:30 UTC (previous day)
        isAvailable: true,
        bookedCount: 0,
        maxBookings: 15
      }
    ...
    prisma.teacherScheduleSlot.upsert({
      ...
      create: {
        ...
        startTime: new Date('2025-10-06T12:30:00Z'), // 17:30 EST - 15 hours = 12:30 UTC
        endTime: new Date('2025-10-06T13:30:00Z'), // 18:30 EST - 15 hours = 13:30 UTC
        isAvailable: true,
        bookedCount: 0,
        maxBookings: 15
      }
    ...
    prisma.teacherScheduleSlot.upsert({
      ...
      create: {
        ...
        startTime: new Date('2025-10-07T12:30:00Z'), // 17:30 EST - 15 hours = 12:30 UTC
        endTime: new Date('2025-10-07T13:30:00Z'), // 18:30 EST - 15 hours = 13:30 UTC
        isAvailable: true,
        bookedCount: 0,
        maxBookings: 15
      }
    ...
    prisma.teacherScheduleSlot.upsert({
      ...
      create: {
        ...
        startTime: new Date('2025-10-07T13:45:00Z'), // 18:45 EST - 15 hours = 13:45 UTC
        endTime: new Date('2025-10-07T14:45:00Z'), // 19:45 EST - 15 hours = 14:45 UTC
        isAvailable: true,
        bookedCount: 0,
        maxBookings: 15
      }
    ...
    prisma.teacherScheduleSlot.upsert({
      ...
      create: {
        ...
        startTime: new Date('2025-10-08T03:15:00Z'), // 08:15 EST - 15 hours = 03:15 UTC (previous day)
        endTime: new Date('2025-10-08T04:15:00Z'), // 09:15 EST - 15 hours = 04:15 UTC (previous day)
        isAvailable: true,
        bookedCount: 0,
        maxBookings: 15
      }
    ...
    prisma.teacherScheduleSlot.upsert({
      ...
      create: {
        ...
        startTime: new Date('2025-10-08T04:30:00Z'), // 09:30 EST - 15 hours = 04:30 UTC (previous day)
        endTime: new Date('2025-10-08T05:30:00Z'), // 10:30 EST - 15 hours = 05:30 UTC (previous day)
        isAvailable: true,
        bookedCount: 0,
        maxBookings: 15
      }
    ...
    prisma.teacherScheduleSlot.upsert({
      ...
      create: {
        ...
        startTime: new Date('2025-10-08T12:30:00Z'), // 17:30 EST - 15 hours = 12:30 UTC
        endTime: new Date('2025-10-08T13:30:00Z'), // 18:30 EST - 15 hours = 13:30 UTC
        isAvailable: true,
        bookedCount: 0,
        maxBookings: 15
      }
    ...
    prisma.teacherScheduleSlot.upsert({
      ...
      create: {
        ...
        startTime: new Date('2025-10-09T12:30:00Z'), // 17:30 EST - 15 hours = 12:30 UTC
        endTime: new Date('2025-10-09T13:30:00Z'), // 18:30 EST - 15 hours = 13:30 UTC
        isAvailable: true,
        bookedCount: 0,
        maxBookings: 15
      }
    ...
    prisma.teacherScheduleSlot.upsert({
      ...
      create: {
        ...
        startTime: new Date('2025-10-09T13:45:00Z'), // 18:45 EST - 15 hours = 13:45 UTC
        endTime: new Date('2025-10-09T14:45:00Z'), // 19:45 EST - 15 hours = 14:45 UTC
        isAvailable: true,
        bookedCount: 0,
        maxBookings: 15
      }
    ...
    prisma.teacherScheduleSlot.upsert({
      ...
      create: {
        ...
        startTime: new Date('2025-10-10T03:15:00Z'), // 08:15 EST - 15 hours = 03:15 UTC (previous day)
        endTime: new Date('2025-10-10T04:15:00Z'), // 09:15 EST - 15 hours = 04:15 UTC (previous day)
        isAvailable: true,
        bookedCount: 0,
        maxBookings: 15
      }
    ...
    prisma.teacherScheduleSlot.upsert({
      ...
      create: {
        ...
        startTime: new Date('2025-10-10T04:30:00Z'), // 09:30 EST - 15 hours = 04:30 UTC (previous day)
        endTime: new Date('2025-10-10T05:30:00Z'), // 10:30 EST - 15 hours = 05:30 UTC (previous day)
        isAvailable: true,
        bookedCount: 0,
        maxBookings: 15
      }
    ...
    prisma.teacherScheduleSlot.upsert({
      ...
      create: {
        ...
        startTime: new Date('2025-10-10T12:30:00Z'), // 17:30 EST - 15 hours = 12:30 UTC
        endTime: new Date('2025-10-10T13:30:00Z'), // 18:30 EST - 15 hours = 13:30 UTC
        isAvailable: true,
        bookedCount: 0,
        maxBookings: 15
      }
    ...
    prisma.teacherScheduleSlot.upsert({
      ...
      create: {
        ...
        startTime: new Date('2025-10-11T03:30:00Z'), // 08:30 EST - 15 hours = 03:30 UTC (previous day)
        endTime: new Date('2025-10-11T04:30:00Z'), // 09:30 EST - 15 hours = 04:30 UTC (previous day)
        isAvailable: true,
        bookedCount: 0,
        maxBookings: 15
      }
    ...
    prisma.teacherScheduleSlot.upsert({
      ...
      create: {
        ...
        startTime: new Date('2025-10-11T04:45:00Z'), // 09:45 EST - 15 hours = 04:45 UTC (previous day)
        endTime: new Date('2025-10-11T05:45:00Z'), // 10:45 EST - 15 hours = 05:45 UTC (previous day)
        isAvailable: true,
        bookedCount: 0,
        maxBookings: 15
      }
  ...
  const septemberScheduleSlots = await Promise.all([
    ...
    prisma.teacherScheduleSlot.upsert({
      ...
      create: {
        teacherScheduleId: teacherSchedules[0].id, // Monday 08:15 Hatha
        startTime: new Date('2025-09-01T03:15:00Z'), // 08:15 EST - 15 hours = 03:15 UTC (previous day)
        endTime: new Date('2025-09-01T04:15:00Z'), // 09:15 EST - 15 hours = 04:15 UTC (previous day)
        isAvailable: true,
        bookedCount: 0,
        maxBookings: 15
      }
    ...
    prisma.teacherScheduleSlot.upsert({
      ...
      create: {
        teacherScheduleId: teacherSchedules[1].id, // Monday 09:30 Vinyasa
        startTime: new Date('2025-09-01T04:30:00Z'), // 09:30 EST - 15 hours = 04:30 UTC (previous day)
        endTime: new Date('2025-09-01T05:30:00Z'), // 10:30 EST - 15 hours = 05:30 UTC (previous day)
        isAvailable: true,
        bookedCount: 0,
        maxBookings: 15
      }
    ...
    prisma.teacherScheduleSlot.upsert({
      ...
      create: {
        teacherScheduleId: teacherSchedules[2].id, // Monday 17:30 Hatha
        startTime: new Date('2025-09-01T12:30:00Z'), // 17:30 EST - 15 hours = 12:30 UTC
        endTime: new Date('2025-09-01T13:30:00Z'), // 18:30 EST - 15 hours = 13:30 UTC
        isAvailable: true,
        bookedCount: 0,
        maxBookings: 15
      }
    ...
    prisma.teacherScheduleSlot.upsert({
      ...
      create: {
        teacherScheduleId: teacherSchedules[3].id, // Tuesday 17:30 Hatha
        startTime: new Date('2025-09-02T12:30:00Z'), // 17:30 EST - 15 hours = 12:30 UTC
        endTime: new Date('2025-09-02T13:30:00Z'), // 18:30 EST - 15 hours = 13:30 UTC
        isAvailable: true,
        bookedCount: 0,
        maxBookings: 15
      }
    ...
    prisma.teacherScheduleSlot.upsert({
      ...
      create: {
        teacherScheduleId: teacherSchedules[4].id, // Tuesday 18:45 Vinyasa
        startTime: new Date('2025-09-02T13:45:00Z'), // 18:45 EST - 15 hours = 13:45 UTC
        endTime: new Date('2025-09-02T14:45:00Z'), // 19:45 EST - 15 hours = 14:45 UTC
        isAvailable: true,
        bookedCount: 0,
        maxBookings: 15
      }
    ...
    prisma.teacherScheduleSlot.upsert({
      ...
      create: {
        teacherScheduleId: teacherSchedules[5].id, // Wednesday 08:15 Hatha
        startTime: new Date('2025-09-03T03:15:00Z'), // 08:15 EST - 15 hours = 03:15 UTC (previous day)
        endTime: new Date('2025-09-03T04:15:00Z'), // 09:15 EST - 15 hours = 04:15 UTC (previous day)
        isAvailable: true,
        bookedCount: 0,
        maxBookings: 15
      }
    ...
    prisma.teacherScheduleSlot.upsert({
      ...
      create: {
        teacherScheduleId: teacherSchedules[6].id, // Wednesday 09:30 Vinyasa
        startTime: new Date('2025-09-03T04:30:00Z'), // 09:30 EST - 15 hours = 04:30 UTC (previous day)
        endTime: new Date('2025-09-03T05:30:00Z'), // 10:30 EST - 15 hours = 05:30 UTC (previous day)
        isAvailable: true,
        bookedCount: 0,
        maxBookings: 15
      }
    ...
    prisma.teacherScheduleSlot.upsert({
      ...
      create: {
        teacherScheduleId: teacherSchedules[7].id, // Wednesday 17:30 Hatha
        startTime: new Date('2025-09-03T12:30:00Z'), // 17:30 EST - 15 hours = 12:30 UTC
        endTime: new Date('2025-09-03T13:30:00Z'), // 18:30 EST - 15 hours = 13:30 UTC
        isAvailable: true,
        bookedCount: 0,
        maxBookings: 15
      }
    ...
    prisma.teacherScheduleSlot.upsert({
      ...
      create: {
        teacherScheduleId: teacherSchedules[9].id, // Thursday 18:45 Vinyasa
        startTime: new Date('2025-09-04T13:45:00Z'), // 18:45 EST - 15 hours = 13:45 UTC
        endTime: new Date('2025-09-04T14:45:00Z'), // 19:45 EST - 15 hours = 14:45 UTC
        isAvailable: true,
        bookedCount: 0,
        maxBookings: 15
      }
    ...
    prisma.teacherScheduleSlot.upsert({
      ...
      create: {
        teacherScheduleId: teacherSchedules[10].id, // Friday 08:15 Hatha
        startTime: new Date('2025-09-05T03:15:00Z'), // 08:15 EST - 15 hours = 03:15 UTC (previous day)
        endTime: new Date('2025-09-05T04:15:00Z'), // 09:15 EST - 15 hours = 04:15 UTC (previous day)
        isAvailable: true,
        bookedCount: 0,
        maxBookings: 15
      }
    ...
    prisma.teacherScheduleSlot.upsert({
      ...
      create: {
        teacherScheduleId: teacherSchedules[11].id, // Friday 09:30 Vinyasa
        startTime: new Date('2025-09-05T04:30:00Z'), // 09:30 EST - 15 hours = 04:30 UTC (previous day)
        endTime: new Date('2025-09-05T05:30:00Z'), // 10:30 EST - 15 hours = 05:30 UTC (previous day)
        isAvailable: true,
        bookedCount: 0,
        maxBookings: 15
      }
    ...
    prisma.teacherScheduleSlot.upsert({
      ...
      create: {
        teacherScheduleId: teacherSchedules[12].id, // Friday 17:30 Hatha
        startTime: new Date('2025-09-05T12:30:00Z'), // 17:30 EST - 15 hours = 12:30 UTC
        endTime: new Date('2025-09-05T13:30:00Z'), // 18:30 EST - 15 hours = 13:30 UTC
        isAvailable: true,
        bookedCount: 0,
        maxBookings: 15
      }
    ...
    prisma.teacherScheduleSlot.upsert({
      ...
      create: {
        teacherScheduleId: teacherSchedules[13].id, // Saturday 08:30 Hatha
        startTime: new Date('2025-09-06T03:30:00Z'), // 08:30 EST - 15 hours = 03:30 UTC (previous day)
        endTime: new Date('2025-09-06T04:30:00Z'), // 09:30 EST - 15 hours = 04:30 UTC (previous day)
        isAvailable: true,
        bookedCount: 0,
        maxBookings: 15
      }
    ...
    prisma.teacherScheduleSlot.upsert({
      ...
      create: {
        teacherScheduleId: teacherSchedules[14].id, // Saturday 09:45 Vinyasa
        startTime: new Date('2025-09-06T04:45:00Z'), // 09:45 EST - 15 hours = 04:45 UTC (previous day)
        endTime: new Date('2025-09-06T05:45:00Z'), // 10:45 EST - 15 hours = 05:45 UTC (previous day)
        isAvailable: true,
        bookedCount: 0,
        maxBookings: 15
      }
  ...
  const currentWeekScheduleSlots = await Promise.all([
    ...
    prisma.teacherScheduleSlot.upsert({
      ...
      create: {
        teacherScheduleId: teacherSchedules[5].id, // Wednesday 08:15 Hatha
        startTime: new Date('2025-09-17T03:15:00Z'), // 08:15 EST - 15 hours = 03:15 UTC (previous day)
        endTime: new Date('2025-09-17T04:15:00Z'), // 09:15 EST - 15 hours = 04:15 UTC (previous day)
        isAvailable: true,
        bookedCount: 0,
        maxBookings: 15
      }
    ...
    prisma.teacherScheduleSlot.upsert({
      ...
      create: {
        teacherScheduleId: teacherSchedules[6].id, // Wednesday 09:30 Vinyasa
        startTime: new Date('2025-09-17T04:30:00Z'), // 09:30 EST - 15 hours = 04:30 UTC (previous day)
        endTime: new Date('2025-09-17T05:30:00Z'), // 10:30 EST - 15 hours = 05:30 UTC (previous day)
        isAvailable: true,
        bookedCount: 0,
        maxBookings: 15
      }
    ...
    prisma.teacherScheduleSlot.upsert({
      ...
      create: {
        teacherScheduleId: teacherSchedules[7].id, // Wednesday 17:30 Hatha
        startTime: new Date('2025-09-17T12:30:00Z'), // 17:30 EST - 15 hours = 12:30 UTC
        endTime: new Date('2025-09-17T13:30:00Z'), // 18:30 EST - 15 hours = 13:30 UTC
        isAvailable: true,
        bookedCount: 0,
        maxBookings: 15
      }
