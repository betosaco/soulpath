// Test the exact date calculation logic from the API
const now = new Date();
...
const testEnd = new Date('2025-09-22');
...
const rangesMatch = dateStart.toISOString().split('T')[0] === testStart.toISOString().split('T')[0] && 
                   dateEnd.toISOString().split('T')[0] === testEnd.toISOString().split('T')[0];

console.log('\nRanges match:', rangesMatch);
