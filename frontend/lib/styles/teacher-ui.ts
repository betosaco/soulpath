...
export const teacherUI = {
  ...
  sidebar: {
    container: 'flex w-64 flex-col bg-[var(--unified-bg-secondary)] border-r border-[var(--unified-border-light)]',
    header: 'flex h-16 items-center justify-center border-b border-[var(--unified-border-light)]',
    section: 'px-4 py-4 border-b border-[var(--unified-border-light)]',
    nav: 'flex-1 space-y-1 px-4 py-6',
    footer: 'border-t border-[var(--unified-border-light)] p-4',
    brandTitle: 'text-xl font-bold text-[var(--unified-text-primary)]',
    brandTagline: 'text-xs text-[var(--unified-text-secondary)]',
  },
  header: {
