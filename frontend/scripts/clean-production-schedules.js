...
/**
 * Clean Production Schedules Script
 * 
 * This script cleans up and recreates the production schedules correctly
 */
...
async function cleanProductionSchedules() {
  console.log('🧹 Cleaning Production Schedules\n');
  console.log('================================\n');
  ...
  try {
    ...
    // Verify the results
    console.log('\n📋 Final production schedule verification:');
    ...
    console.log('\n🎉 Production schedules cleaned and fixed successfully!');

  } catch (error) {
    console.error('❌ Error cleaning production schedules:', error);
    process.exit(1);
  } finally {
