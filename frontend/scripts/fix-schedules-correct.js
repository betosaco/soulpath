...
/**
 * Fix Schedules Correct Script
 * 
 * This script fixes all schedules with the correct service type IDs
 * ID 1 = Vinyasa Yoga, ID 2 = Hatha Yoga
 */
...
async function fixSchedulesCorrect() {
  console.log('🔧 Fixing Schedules with Correct Service Type IDs\n');
  console.log('==================================================\n');
