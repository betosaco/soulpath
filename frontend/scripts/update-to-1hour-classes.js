...
async function updateTo1HourClasses() {
  try {
    console.log('🔄 Updating system to use 1-hour classes...');
    ...
    // 4. Update schedule templates to use 1-hour sessions
    console.log('📅 Updating schedule templates...');
    ...
    for (const template of scheduleTemplates) {
      ...
      console.log(`✅ Updated schedule template: ${updatedTemplate.id}`);
    }

    console.log('');
    console.log('🎉 Successfully updated system to use 1-hour classes!');
    console.log('');
    console.log('📊 Updated:');
    ...
    console.log('');
    console.log('🚀 Your system now uses 1-hour classes throughout!');
