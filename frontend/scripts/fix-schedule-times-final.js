...
async function fixScheduleTimesFinal() {
  try {
    console.log('🔄 Fixing schedule times to correct UTC values...');
    ...
    // Create new schedule pattern with correct UTC times
    // EST times need to be converted to UTC: EST = UTC - 5 hours
    const newSchedules = [
    ...
    console.log('\n🎉 Final schedule pattern with correct times updated successfully!');
